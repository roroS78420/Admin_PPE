...
<link rel="stylesheet" type="text/css" href="css/search.css">
  ...
  <div class="navbar navbar-dark bg-dark shadow-sm">
    <div class="container">
      <a href="homeAdmin" class="navbar-brand d-flex align-items-center">
      ...
      <a href="insertProduit" class="navbar-brand d-flex align-items-center">
        ...
        <strong>Insertion de produit</strong>
      </a>
...
<?php
  ...
  <div class="navbar navbar-dark bg-dark shadow-sm">
    <div class="container">
       <a href="connexionAdmin" class="navbar-brand d-flex align-items-center">
   ...
   <div class="container">
        <div class="row">
            <div class="col-md-3 col-lg-4 col-xl-3">
                ...
                <p class="mb-0">
                    Un jour on mettra une description correcte, un jour certe, mais pour l'instant on a la flemme d'en mettre une.
                </p>
            </div>
